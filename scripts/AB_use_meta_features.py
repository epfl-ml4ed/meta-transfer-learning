...
save_name = 'run_history/meta_features_100e_best_model_all_layers' + '_20' + week_type + '_bilstm'
...
for percentile in early_predict:
    ...
    for model in rnn_models:
        ...
        run_name = "best_meta_easy_fail_" + model.__name__  + "_ep" + str(percentile) + "_" + current_timestamp
